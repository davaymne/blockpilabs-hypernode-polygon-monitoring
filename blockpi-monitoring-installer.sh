...
function installNodeExporter {
  ...
  wget -O /etc/systemd/system/node_exporter.service  https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-polygon-monitoring/main/node_exporter.service
...
function installPrometheus {
	...
	cd /opt/prometheus
	echo -e '\n\e[42mDownloading packages...\e[0m\n'
  wget -O prometheus.yml https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-polygon-monitoring/main/prometheus/prometheus.yml
  ...
  wget -O /etc/systemd/system/prometheus.service https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-polygon-monitoring/main/prometheus.service
...
function installGrafana {
  ...
  wget -O /etc/grafana/provisioning/datasources/prometheus.yml https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-polygon-monitoring/main/grafana/provisioning/datasources/prometheus.yml
  wget -O /etc/grafana/provisioning/dashboards/dashboards.yml https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-polygon-monitoring/main/grafana/provisioning/dashboards/dashboards.yml
	wget -O /etc/grafana/provisioning/dashboards/HyperNode.json https://raw.githubusercontent.com/davaymne/blockpilabs-hypernode-polygon-monitoring/main/grafana/provisioning/dashboards/HyperNode.json
